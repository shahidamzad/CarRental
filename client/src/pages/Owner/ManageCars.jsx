...
const ManageCars = () => {
  ...
  const toggleAvailability = async (carId) => {
    try {
      const { data } = await axios.post('/api/owners/toggle-cars', {carId})
      if (data.success) {
  ...
  return (
    ...
    <div className='px-4 pt-10 md:px-10 w-full '>
      ...
      <Title title='Manage Car' subTitle='View all listed cars , update their details , or remove them from the booking platform ' />
              ...
              <tr key={index} className='border-t border-borderColor'>
                ...
                <td className='p-3 flex items-center gap-3 '>
                  ...
                  <div className='max-md:hidden'>
                    ...
                    <p className='text-sm text-gray-500'> {car.seating_capacity} • {car.transmission}
                    </p>
                  </div>
                </td>
