...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <form onSubmit={onSubmitHandle} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl ' >
        {/* Car image  */}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
          ...
          <div className='flex flex-col w-full '>
            <label>Model </label>
            <input type="text" placeholder='e.g. X5, M-4' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.model} onChange={e => setCar({ ...car, model: e.target.value })} />
        ...
        <div className='flex flex-col w-full '>
          ...
          <textarea rows={5} placeholder='e.g. A luxurious SUV with a spacious interior and a power ful engine' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e => setCar({ ...car, description: e.target.value })} >
