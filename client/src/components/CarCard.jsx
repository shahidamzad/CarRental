...
const CarCard = ({ car }) => {
    ...
    return (
        <div onClick={()=>{
            navigate(`/carDetails/${car._id}`); scrollTo(0,0)
            ...
            <div className='relative h-48 overflow-hidden'>
                ...
                {car.isAvailable && <p className='absolute top-4 left-4 bg-primery/90 text-white text-xs px-2.5 py-1 rounded-full'>Available Now </p>}
            ...
            <div className='p-4 sm:p-5 '>
                ...
                <div className='mt-4 gri  grid-cols-2 gap-2 text-gray-600'>
